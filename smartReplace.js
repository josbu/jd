...
async function downloader_jd() {
    if (/require\(['"`]{1}.\/jdCookie.js['"`]{1}\)/.test(remoteContent))
        await download("https://github.com/oslook/jd/raw/main/jdCookie.js", "./jdCookie.js", "京东Cookies");
    if (remoteContent.indexOf("jdFruitShareCodes") > 0) {
        await download(
            "https://github.com/oslook/jd/raw/main/jdFruitShareCodes.js",
    ...
    if (remoteContent.indexOf("jdPetShareCodes") > 0) {
        await download(
            "https://github.com/oslook/jd/raw/main/jdPetShareCodes.js",
            "./jdPetShareCodes.js",
            "京东萌宠"
        );
    }
    if (remoteContent.indexOf("jdPlantBeanShareCodes") > 0) {
        await download(
            "https://github.com/oslook/jd/raw/main/jdPlantBeanShareCodes.js",
    ...
    if (remoteContent.indexOf("jdSuperMarketShareCodes") > 0)
        await download(
            "https://github.com/oslook/jd/raw/main/jdSuperMarketShareCodes.js",
            "./jdSuperMarketShareCodes.js",
            "京小超互助码"
        );
    if (remoteContent.indexOf("jdFactoryShareCodes") > 0) {
        await download(
            "https://github.com/oslook/jd/raw/main/jdFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("jdDreamFactoryShareCodes") > 0) {
        await download(
            "https://github.com/oslook/jd/raw/main/jdDreamFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("new Env('京喜农场')") > 0) {
        await download(
            "https://github.com/oslook/jd/raw/main/jdJxncTokens.js",
            "./jdJxncTokens.js",
            "京喜农场Token"
        );
        await download(
            "https://github.com/oslook/jd/raw/main/jdJxncShareCodes.js",
            "./jdJxncShareCodes.js",
            "京喜农场分享码"
        );
        await download(
            "https://github.com/oslook/jd/raw/main/USER_AGENTS.js",
            "./USER_AGENTS.js",
            "USER_AGENTS"
        );
    }
...
async function downloader_notify() {
    await download("https://github.com/oslook/jd/raw/main/sendNotify.js", "./sendNotify.js", "统一通知");
}

async function downloader_user_agents() {
    await download("https://github.com/oslook/jd/raw/main/USER_AGENTS.js", "./USER_AGENTS.js", "云端UA");
}
